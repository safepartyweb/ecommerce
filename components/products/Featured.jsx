    ...
    <section className='sec_new_arrivals py-6 md:py-10 '>
      <div className='container max-w-sitemax px-4 mx-auto '>
        ...
        <div className="prodcuts_wrap flex gap-5 md:gap-8 justify-center flex-wrap ">
          ...
          {newArrivals.map(product=> <AnimatedBlock key={product._id} direction='up' className=' w-full sm:w-[45%] lg:w-[23%] single_product border border-siteBlack rounded p-4 md:p-6'> <div  className=" flex gap-6 flex-col justify-center items-center">
